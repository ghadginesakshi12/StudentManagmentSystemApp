...
crossorigin="anonymous">
 <style type="text/css"> 
 .enroll{ background-image: url("images/addstudentbg.jpeg"); 
 ...
 background-size: cover; background-repeat: no-repeat; }
  .heading{ font-family:cursive;
   ...
   margin-bottom: 20px; } 
   form{ width:400px } 
   .view{ background-image: url("images/viewstudents.jpeg"); 
   background-size: cover; background-repeat: no-repeat; } 
   </style>
</head>
<body>
...
<img src="images/cjclogo.jpeg" 
width="100px" 
height="50px"> 
<div class="pt-2"> 
<a href="#enroll"> 
<button class="btn btn-outline-primary">Enroll Student
</button> </a> <a href="#view"> 
<button class="btn btn-outline-primary">View Student
</button> </a> <a href="/"> 
<button class="btn btn-outline-primary">Logout
 ...
 <section class="vh-100 gradient-custom enroll mt-2" id="enroll">
  <div class="container h-100">
   ...
   style="border-radius: 15px;"> <div class="card-body mt-0">
    <h3 class="heading">Student Enrollment Form
    </h3> 
        ...
        id="birthdayDate"
         ...
         class="form-label">Student Age
          ...
          <div class="col-md-6 mb-2 pb-2">
           ...
           <label class="form-label" for="phoneNumber">Student Collage Name
           </label>
            </div>
            </div> 
            </div>
             <div class="row">
              ...
              <label class="form-label" for="emailAddress">Fees Paid
              </label> 
              </div> 
              </div>
                ...
                <div class="form-check form-check-inline">
                 ...
                 <label class="form-check-label" for="python">Python</label> 
                  ...
                  <label class="form-check-label" for="testing">Testing</label>
                     ...
                     <option value="#" disabled >Select Batch Mode
                     </option> <option value="Online">Online
                     </option> <option value="Offline">Offline
                     </option> </select> <label class="form-label select-label">Batch Mode
                     </label> 
                     </div> 
                     <div class="col">
                      <select class="select form-control-sm" name="batchNumber"> 
                      <option value="#" disabled>Select Batch Number
                      </option> 
                      <option value="FDJ-181">FDJ-181
                      </option> 
                      <option value="REG-181">REG-181
                      </option> 
                      </select> 
                      <label class="form-label select-label">Batch Number
                      </label> 
                      </div>
                       </div>
                        ...
                        <input class="btn btn-primary btn-lg" type="submit" value="Submit" /> 
                          ...
                          <section class="view" style="height:530px" id="view"> <h1>View Student</h1>
                           </section>
                           </div> 
                           </body> 
                           </html>
